    ...
    <body>
        <div class="grid">
            ...
            if (!isset($_SESSION['usuario_nombre'])) {
                ...
                $link = conectarlocal();
                $id = $_GET['id'];
                $consulta = sprintf("SELECT id, name, lastname, email, user_type_id FROM user WHERE id = '%s'", mysql_real_escape_string($id));
                ...
                <form name="actualizarusuario" action="update_data.php" method="post" >
                    ...
                    <br>
                    <label name="txtapellido">Apellido </label><input value="<?php echo $ver['lastname']; ?>" type="text" name="txtapellido" size="20">
                    <br>
                    <label name="txtemail">Email</label><input value="<?php echo $ver['email']; ?>" type="text" name="usuario_email" size="20">
                    <br>
                    ...
                    <br />
                    <?php
                    $value = $ver[user_type_id];
                    $namecombo = "boxtype_user";
                    combobox("$namecombo", "user_type", "name", "$value");
                    ?>
                    <br>
