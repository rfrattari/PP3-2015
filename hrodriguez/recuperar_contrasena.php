    ...
    <?php
        ...
        if(isset($_POST['enviar'])) { // compruebo que se han enviado los datos del formulario
            if(empty($_POST['usuario_nombre'])) {
                ...
                $sql = mysql_query("SELECT name, password, email FROM user WHERE name='".$usuario_nombre."'");
                if(mysql_num_rows($sql)) {
                    ...
                    mysql_query("UPDATE user SET password='".$usuario_clave2."' WHERE name='".$usuario_nombre."'");
